...
class LongMemoryExtractor:
    ...
    def _build_prompt(self, trimmed: str) -> str:
        ...
        return (
            ...
            "- If one message contains multiple answer-bearing clauses, emit one event per clause.\n"
            "- Do not collapse different objects, quantities, or time anchors into one event.\n"
            ...
            "- For comparison questions, keep each anchor as a separate event when possible.\n"
            "- For list/count-like content, preserve the answer-bearing entities or quantities explicitly.\n"
